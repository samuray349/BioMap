        ...
        <div class="mx-auto" style="max-width: 1500px;">
            <div class="mx-auto mb-8" style="max-width: 1400px;">
                <div class="flex justify-end">
                    <button id="share-button" class="px-3 py-1 border border-gray-300 rounded-full text-sm bg-white hover:bg-gray-50 transition">
                        Partilhar
                    </button>
                </div>
            </div>
                ...
                <div class="bg-white p-6 rounded-xl shadow animal-card" style="flex-direction: column; display: flex; align-self: stretch;">
                    <div style="display: flex; flex-direction: column; gap: 1rem; flex-grow: 1;">
                        ...
                        <div class="flex items-center">
                            <div class="w-12 h-12 rounded-full flex items-center justify-center mr-4" style="background-color: #FFCC00; color: white;" id="estado-conservacao-icon">
