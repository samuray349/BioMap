...
- Registo de animais: Um administrador irá poder criar, atualizar e apagar registos de animais, cada registo vai ter dados como nome, descrição, características físicas, risco de extinção
